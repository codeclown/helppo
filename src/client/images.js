export default function images(mountpath) {
  return {
    ...
    sortAsc: `${mountpath}/assets/static/sortAsc.svg`,
    sortDesc: `${mountpath}/assets/static/sortDesc.svg`,
    columnInfo: `${mountpath}/assets/static/columnInfo.svg`,
    calendar: `${mountpath}/assets/static/calendar.svg`,
    navIconTable: `${mountpath}/assets/static/navIconTable.svg`,
    navIconDots: `${mountpath}/assets/static/navIconDots.svg`,
  };
}
