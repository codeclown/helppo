...
describe("pgSql", () => {
  describe("buildSchemaSql", () => {
    ...
    schemaSqlSpecHelper(buildSchemaSql);
  });
  ...
  describe("getCommentsSql", () => {
    it("works", () => {
      matchSnapshot(getCommentsSql([]));
      matchSnapshot(getCommentsSql(["users"]));
      matchSnapshot(getCommentsSql(["users", "tables"]));
    });
  });

  describe("getPrimaryKeysSql", () => {
    it("works", () => {
      matchSnapshot(getPrimaryKeysSql([]));
      matchSnapshot(getPrimaryKeysSql(["users"]));
      matchSnapshot(getPrimaryKeysSql(["users", "tables"]));
    });
  });
  ...
  describe("getInsertRowSql", () => {
    it("works", () => {
      matchSnapshot(getInsertRowSql("users", "id", ["name"], ["foobar"]));
      matchSnapshot(
        getInsertRowSql(
          "users",
          "id",
